-- =====================================================================
-- SCRIPT MAESTRO POSTGRESQL 16 (VotoReal Lima)
-- ESTRUCTURA 100% IDÉNTICA EN TABLAS, NOMBRES Y CANTIDAD DE COLUMNAS
-- =====================================================================
...
CREATE TABLE IF NOT EXISTS votos_detalle (
    ...
    p_fp_candidato VARCHAR(150),
    p_fp_votos INT DEFAULT 0,
    p_jp_candidato VARCHAR(150),
    p_jp_votos INT DEFAULT 0,
    p_sp_candidato VARCHAR(150),
    p_sp_votos INT DEFAULT 0,
    p_frepap_candidato VARCHAR(150),
    p_frepap_votos INT DEFAULT 0,
    p_verde_candidato VARCHAR(150),
    p_verde_votos INT DEFAULT 0,
    p_morado_candidato VARCHAR(150),
    ...
    d_jp_candidato VARCHAR(150),
    d_jp_votos INT DEFAULT 0,
    d_sp_candidato VARCHAR(150),
    d_sp_votos INT DEFAULT 0,
    d_frepap_candidato VARCHAR(150),
    d_frepap_votos INT DEFAULT 0,
    d_verde_candidato VARCHAR(150),
    d_verde_votos INT DEFAULT 0,
    d_morado_candidato VARCHAR(150),
...
-- =====================================================================
-- INSERCIÓN DE USUARIOS PRINCIPALES
-- =====================================================================
...
-- =====================================================================
-- INSERCIÓN DE LOS 10 REGISTROS EXACTOS EN RPERSONEROS
-- =====================================================================
...
-- =====================================================================
-- CARGA DE LOS 123 LOCALES Y 1,650 MESAS
-- =====================================================================
